...
Abordagem do que foi desenvolvido
O projeto disponível no repositório foi gerado há algum tempo, e optei por gerar um novo com o Vite. Isso também resolveu uma série de CVEs. Aqui será abordado como foram desenvolvidos os recursos descritos no [README.md](README.md).
